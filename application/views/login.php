...
<head>
  ...
  <link rel="icon" type="image/png" href="<?php echo base_url() ?>assets/img/favicon-32x32.png">
  ...
  <style>
    body {
/*      background-image: url("<?php echo base_url(); ?>assets/img/logo_2.png");*/
            ...
            <form class="form" method="POST" action="<?php echo base_url('Auth/auth') ?>">
              <div class="card card-login card-hidden">
                <div class="card-header card-header-primary text-center">
                  <h4 class="card-title"><i>PLUS FIT</i></h4>

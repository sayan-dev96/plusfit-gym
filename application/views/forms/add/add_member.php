                ...
                <div class="card-body ">
                  <form method="POST" action="#" class="form-horizontal" id="member_frm">
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        <div class="form-group bmd-form-group">
                          <input type="text" name="mem_no" id="mem_no" class="form-control" maxlength="10" required>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        <div class="form-group bmd-form-group">
                          <input type="text" id="mem_name" name="mem_name" class="form-control" onkeydown="return /[a-z]/i.test(event.key)" required>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-3">
                        <div class="form-group bmd-form-group">
                          <input type="text" name="mem_father" id="mem_father" class="form-control" onkeydown="return /[a-z]/i.test(event.key)" required>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="row" >
                      ...
                      <div class="col-sm-10 checkbox-radios">
                        <div class="form-check">
                          ...
                          <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" id="HP" value="HP"> Hepatitis 
                            <span class="form-check-sign">
                              <span class="check"></span>
                            </span>
                          </label>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        <div class="form-group bmd-form-group">
                          <input type="text" name="mem_residence" id="mem_residence" class="form-control" placeholder="Name of City" onkeydown="return /[a-z]/i.test(event.key)" required>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        <div class="form-group bmd-form-group">
                          <input type="number" name="mem_tel" id="mem_tel" class="form-control" placeholder="98xxxxxxxx" maxlength="10" required>
                      ...
                      <div class="col-sm-2">
                        <div class="form-group bmd-form-group">
                          <input type="number" name="mem_fax" id="mem_fax" class="form-control" hidden>
                  ...
                  <br>
                   <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-2">
                        <div class="form-group bmd-form-group">
                          <input type="text" id="mem_monthly_price"  value="0" name="mem_monthly_price" class="form-control" readonly>
                          &#x20b9;
                      ...
                      <div class="col-sm-2">
                        <div class="form-group bmd-form-group">
                          <input type="text" id="mem_subtotal_price" name="mem_subtotal_price" class="form-control"  value="0" readonly>&#x20b9;

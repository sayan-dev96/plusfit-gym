                              ...
                              <tr>
                                ...
                                if($this->session->userdata('access_level')==1)
                                {
                                  ?>
                                    ...
                                    <button type="button" onclick="del_package(<?php echo $pkg->id ?>,<?php echo $pkg->duration ?>)" class="btn btn-link btn-danger btn-just-icon remove"><i class="material-icons">close</i>
